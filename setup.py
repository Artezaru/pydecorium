...
def read_version():
    version_file = "pydecorium/__version__.py"
...
setup(
    ...
    url="https://github.com/Artezaru/pydecorium.git",  # URL to the package's homepage
    ...
    package_data={
        'pydecorium': ['ressources/*'],  # Include all files in ressources/
    },
    entry_points={
        'console_scripts': [
            'pydecorium = pydecorium.__main__:main',  # Define the pydecorium command to run __main__.main()
        ],
    },
)
